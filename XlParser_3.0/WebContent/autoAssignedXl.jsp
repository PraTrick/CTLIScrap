...
<body>
	...
	%0DTotal No. of Assigned Tickets : ${totalAssignedTickets} (Escalated Tickets : ${totalAssignedEscalatedTickets})
	...
	<div id="selectable" onclick="selectText('selectable')">
		...
		<table border="1" id="myTable" class="tablesorter">
			<thead>
				<s:iterator value="escalatedTickets" var="testVar" status="stat">
					<s:if test="%{key == 0}">
						<tr>
